...
let questions = [
    {
    numb: 1,
    question: "What are the names of the five oceans?",
    answer: "Pacific, Atlantic, Indian, Arctic and Southern",
    options: [
      "Pacific, Atlantic, Indian, Arctic and Southern",
      "Red, Pacific, Pennsylvanian, Indian, Southern",
      "Northern, Pennsylvanian, Pacific, Atlantic, Arctic",
      "Western, Pacific, Atlantic, Indian, Arctic"
    ]
  },
...
// Southern Ocean
    ...
    {
    numb: 3,
    question: "What is the name of the biggest ocean on Earth?",
...
// Rio Negro
    ...
    {
    numb: 5,
    question: "Which river flows through the rainforest in brazil?",
    answer: "Amazon",
    options: [
      "Rio Negro",
      "Congo",
...
// Dune
  ...
  {
    numb: 6,
    question: "What do you call land with water on 3 sides?",
    answer: "Peninsula",
    options: [
      "Delta",
      "Plateau",
...
// Eastern
    ...
    {
    numb: 7,
    question: "Which hemisphere does Australia lie on?",
    answer: "Southern",
    options: [
      "Northern",
      "Eastern",
